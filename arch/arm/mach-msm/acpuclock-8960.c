...
// THIS PART FOR MODIFYING AVAILABLE FREQS MrHyde03
static struct acpu_level acpu_freq_tbl_8960_kraitv2_slow[] = {
	...
	{ 1, {  1700000, HFPLL, 1, 0, 0x3E }, L2(16), 1262500 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_8960_kraitv2_nom[] = {
	...
	{ 0, {  1566000, HFPLL, 1, 0, 0x3A }, L2(16), 1200000 },
	{ 1, {  1620000, HFPLL, 1, 0, 0x3C }, L2(16), 1212500 },
	{ 1, {  1700000, HFPLL, 1, 0, 0x3E }, L2(16), 1212500 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_8960_kraitv2_fast[] = {
	...
	{ 0, {  1566000, HFPLL, 1, 0, 0x3A }, L2(16), 1150000 },
	{ 1, {  1620000, HFPLL, 1, 0, 0x3C }, L2(16), 1162500 },
	{ 1, {  1700000, HFPLL, 1, 0, 0x3E }, L2(16), 1162500 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_8960_kraitv2_f3[] = {
	...
	{ 0, {  1566000, HFPLL, 1, 0, 0x3A }, L2(16), 1125000 },
	{ 1, {  1620000, HFPLL, 1, 0, 0x3C }, L2(16), 1137500 },
	{ 1, {  1700000, HFPLL, 1, 0, 0x3E }, L2(16), 1137500 },
	{ 0, { 0 } }
};
		...
		if (fmax) {
			...
			case 0x1:
				...
				if (global_sec_pvs_value == 0xfafa) {
					...
					pr_alert("ACPU PVS: Fast1-r\n");
				} else {
					v2 = acpu_freq_tbl_8960_kraitv2_fast;
					pr_alert("ACPU PVS: Fast1-o\n");
				}
#else
				v2 = acpu_freq_tbl_8960_kraitv2_fast;
#endif
			...
			case 0x2:
				...
				if (global_sec_pvs_value == 0xfafa) {
					v2 = acpu_freq_tbl_8960_kraitv2_nom;
					pr_alert("ACPU PVS: Fast2-r\n");
				} else {
					v2 = acpu_freq_tbl_8960_kraitv2_fast;
					pr_alert("ACPU PVS: Fast2-o\n");
				}
#else
				v2 = acpu_freq_tbl_8960_kraitv2_fast;
#endif
			...
			case 0x3:
				...
				if (global_sec_pvs_value == 0xfafa) {
					v2 = acpu_freq_tbl_8960_kraitv2_nom;
					pr_alert("ACPU PVS: Fast3-r\n");
				} else {
					v2 = acpu_freq_tbl_8960_kraitv2_fast;
					pr_alert("ACPU PVS: Fast3-o\n");
				}
#else
				/* apply same fast table for temporary */
				v2 = acpu_freq_tbl_8960_kraitv2_fast;
#endif
				break;
			}
