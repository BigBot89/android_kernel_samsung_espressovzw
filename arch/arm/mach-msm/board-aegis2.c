...
static u8 touchkey_keycode[] = {KEY_BACK, KEY_HOMEPAGE, KEY_MENU};
static u8 touchkey_keycode_1[] = {KEY_MENU, KEY_F3, KEY_HOMEPAGE, KEY_BACK};

static void cypress_init(void)
{
	if (system_rev >= 3) {
		cypress_touchkey_pdata.touchkey_keycode = touchkey_keycode_1;
		cypress_touchkey_pdata.skip_fw_update = false;
	} else {
...
static struct platform_device opt_gp2a = {
	...
	struct mpu_platform_data mpu6050_data_05 = {
	.int_config = 0x10,
	.orientation = {-1, 0, 0,
			0, 1, 0,
			0, 0, -1},
...
static void mpl_init(void)
{
	...
	if (system_rev < BOARD_REV06 && system_rev >= BOARD_REV01) {
		mpu6050_data = mpu6050_data_05;
		inv_mpu_ak8963_data = inv_mpu_ak8963_data_05;
	} else if (system_rev < BOARD_REV01) {
...
static struct mxt224_platform_data mxt224_data = {
	...
	.config_fw_version = "I415_At_0426",
};
...
static struct platform_device *aegis2_devices[] __initdata = {
	&msm_8960_q6_lpass,
	&msm_8960_q6_mss_fw,
	&msm_8960_q6_mss_sw,
	&msm_8960_riva,
...
static void __init gpio_rev_init(void)
{
	...
	gpio_keys_button[2].gpio = GPIO_HALL_KPD_INT;
#if defined(CONFIG_OPTICAL_GP2A) || defined(CONFIG_OPTICAL_GP2AP020A00F) \
	|| defined(CONFIG_SENSORS_CM36651)
...
static void __init samsung_aegis2_init(void)
{
#ifdef CONFIG_SEC_DEBUG
	sec_debug_init();
#endif
	...
	platform_add_devices(aegis2_devices, ARRAY_SIZE(aegis2_devices));
	msm8960_init_hsic();
	msm8960_init_cam();
	msm8960_init_mmc();
...
MACHINE_START(AEGIS2, "SAMSUNG AEGIS2")
	.map_io = msm8960_map_io,
	.reserve = msm8960_reserve,
	.init_irq = msm8960_init_irq,
	.handle_irq = gic_handle_irq,
	.timer = &msm_timer,
	.init_machine = samsung_aegis2_init,
