...
static void opt_init(void)
{
	...
	usleep_range(2, 3);
	gpio_set_value_cansleep(GPIO_MAG_RST, 1);
}
...
static struct platform_device *espresso10_att_devices[] __initdata = {
	&msm_8960_q6_lpass,
	&msm_8960_q6_mss_fw,
	&msm_8960_q6_mss_sw,
	&msm_8960_riva,
...
static void __init register_i2c_devices(void)
{
	...
	if (machine_is_msm8960_cdp())
		...
		mach_mask = I2C_FFA;
	else if (machine_is_ESPRESSO10_ATT())
		mach_mask = I2C_FFA;
	else
...
static void __init samsung_espresso10_att_init(void)
{
#ifdef CONFIG_SEC_DEBUG
	sec_debug_init();
#endif
...
#endif
	usb_switch_init();
	platform_add_devices(espresso10_att_devices,
			ARRAY_SIZE(espresso10_att_devices));
...
MACHINE_START(ESPRESSO10_ATT, "SAMSUNG ESPRESSO 10 ATT")
	.map_io = msm8960_map_io,
	.reserve = msm8960_reserve,
	.init_irq = msm8960_init_irq,
	.handle_irq = gic_handle_irq,
	.timer = &msm_timer,
	.init_machine = samsung_espresso10_att_init,
