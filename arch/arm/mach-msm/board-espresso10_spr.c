...
#if defined(CONFIG_SENSORS_AL3201) || defined(CONFIG_OPTICAL_BH1721)
...
static struct platform_device *espresso10_spr_devices[] __initdata = {
	&msm_8960_q6_lpass,
	&msm_8960_q6_mss_fw,
	&msm_8960_q6_mss_sw,
	&msm_8960_riva,
...
static void __init register_i2c_devices(void)
{
	...
	if (machine_is_msm8960_cdp())
		...
		mach_mask = I2C_FFA;
	else if (machine_is_ESPRESSO10_SPR())
		mach_mask = I2C_FFA;
	else
...
static void __init samsung_espresso10_spr_init(void)
{
#ifdef CONFIG_SEC_DEBUG
	sec_debug_init();
#endif
...
#endif
	usb_switch_init();
	platform_add_devices(espresso10_spr_devices,
			ARRAY_SIZE(espresso10_spr_devices));
...
MACHINE_START(ESPRESSO10_SPR, "SAMSUNG ESPRESSO 10 SPR")
	.map_io = msm8960_map_io,
	.reserve = msm8960_reserve,
	.init_irq = msm8960_init_irq,
	.handle_irq = gic_handle_irq,
	.timer = &msm_timer,
	.init_machine = samsung_espresso10_spr_init,
