...
static struct platform_device *espresso10_vzw_devices[] __initdata = {
	&msm_8960_q6_lpass,
	&msm_8960_q6_mss_fw,
	&msm_8960_q6_mss_sw,
	&msm_8960_riva,
...
static void __init register_i2c_devices(void)
{
	...
	if (machine_is_msm8960_cdp())
		...
		mach_mask = I2C_FFA;
	else if (machine_is_ESPRESSO10_VZW())
		mach_mask = I2C_FFA;
	else
...
#endif
	usb_switch_init();
	platform_add_devices(espresso10_vzw_devices,
			ARRAY_SIZE(espresso10_vzw_devices));
...
MACHINE_START(ESPRESSO10_VZW, "SAMSUNG ESPRESSO 10 VZW")
	.map_io = msm8960_map_io,
	.reserve = msm8960_reserve,
	.init_irq = msm8960_init_irq,
	.handle_irq = gic_handle_irq,
	.timer = &msm_timer,
	.init_machine = samsung_espresso10_vzw_init,
