...
unsigned int gpio_table[][GPIO_REV_MAX] = {
	...
	/* MDP_VSYNC    */		{  0,  0,  0,  0,  0},
	/* VOLUME_UP    */		{80, 80, 50, 50, 50},
	/* VOLUME_DOWN  */		{81, 81, 81, 81, 81},
	/* PS_EN */			{97, 97, 51, 51, 51},
	/* ALS_SDA */			{63, 63, 12, 12, 12},
	/* ALS_SCL */			{64, 64, 13, 13, 13},
	/* A2220_I2C_SDA */		{12, 12, 36, 36, 36},
	/* A2220_I2C_SCL */		{13, 13, 37, 37, 37},
#ifdef CONFIG_LEDS_MSM_TKEY
	/*TKEY_LED*/			{40, 40, 40, 40, 40},
#endif
	/* MAIN_MIC_BIAS */	{  0,  0, 18, 18, 19},
};
...
static void svc_led_power_onoff(int onoff)
{
...
static void __init svc_led_init(void)
{
	...
	pm8921_data->leds_pdata->led_power_on = svc_led_power_onoff;
}
#endif
...
static struct platform_device *jasper_devices[] __initdata = {
	&msm_8960_q6_lpass,
	&msm_8960_q6_mss_fw,
	&msm_8960_q6_mss_sw,
	&msm_8960_riva,
...
static void __init samsung_jasper_init(void)
{
#ifdef CONFIG_SEC_DEBUG
	sec_debug_init();
#endif
	...
	platform_add_devices(jasper_devices, ARRAY_SIZE(jasper_devices));
	msm8960_init_hsic();
	msm8960_init_cam();
	msm8960_init_mmc();
...
MACHINE_START(JASPER, "SAMSUNG JASPER")
	.map_io = msm8960_map_io,
	.reserve = msm8960_reserve,
	.init_irq = msm8960_init_irq,
	.handle_irq = gic_handle_irq,
	.timer = &msm_timer,
	.init_machine = samsung_jasper_init,
