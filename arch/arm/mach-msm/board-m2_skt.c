...
unsigned int gpio_table[][GPIO_REV_MAX] = {
	...
	/* VOLUME_UP	*/	{ 80, 80, 80, 80, 80, 50, 50, 50, 50},
	/* VOLUME_DOWN	*/	{ 81, 81, 81, 81, 81, 81, 81, 81, 81},
	/* MDP_VSYNC	*/	{ 0, 0, 0, 0, 0, 0, 0, 0, 0},
	/* GPIO_MAG_RST */	{ 66, 66, 66, 66, 66, 48, 48, 48, 9},
	/* ALS_INT */		{ 42, 42, 42, 42, 42, 42, 42, 42,  6 },
#if defined(CONFIG_OPTICAL_GP2A) || defined(CONFIG_OPTICAL_GP2AP020A00F)  \
	|| defined(CONFIG_SENSORS_CM36651)
	/* ALS_SDA */	    { 63, 63, 63, 63, 63, 12, 12, 12, 12},
	/* ALS_SCL */	    { 64, 64, 64, 64, 64, 13, 13, 13, 13},
#endif
    /* TDMB_RST */      { 26, 26, 26, 26, 26, 55, 55, 55, 55},
    /* TDMB_EN  */      { 27, 27, 27, 27, 27, 56, 56, 56, 56 },
    /* TDMB_INT */      { 48, 48, 48, 48, 48, 62, 62, 62, 62},
	/* LCD_22V_EN */	{ 10, 10, 10, 10, 10, 4, 4, 4, 4},
	/* CAM_AF_EN */		{ 54, 54, 54, 54, 54, 77, 77, 77, 77},
	/* CAM_FLASH_SW */	{ 49, 49, 49, 49, 49, 49, 49, 49, 80 },
	/* BT_HOST_WAKE */	{ -1, -1, -1, -1, -1, 10, 10, 10, 10},
	/* BT_WAKE */		{ -1, -1, -1, -1, -1, 79, 79, 79, 79},
	/* BT_EN */		    { -1, -1, -1, -1, -1, 82, 82, 82, 82},
};
...
#ifndef CONFIG_SEC_HALL_DMB
void hall_pmgpio_nc_config(void)
{
	int hall_sensor_ret = 0;
	struct pm_gpio hal_sensor_param = {
		.direction	= PM_GPIO_DIR_IN,
		.pull		= PM_GPIO_PULL_NO,
		.function	= PM_GPIO_FUNC_NORMAL,
		.vin_sel	= 2,
	...
	hall_sensor_ret = pm8xxx_gpio_config(
		PM8921_GPIO_PM_TO_SYS(PMIC_GPIO_HALL_SW_N), &hal_sensor_param);
	if (hall_sensor_ret < 0)
		pr_err("umfa.hall fail to pm8xxx_gpio_config\n");
}
#endif
...
static struct platform_device *m2_skt_devices[] __initdata = {
	&msm_8960_q6_lpass,
	&msm_8960_q6_mss_fw,
	&msm_8960_q6_mss_sw,
	&msm_8960_riva,
...
static void __init samsung_m2_skt_init(void)
{
#ifdef CONFIG_SEC_DEBUG
	sec_debug_init();
#endif
	...
	platform_add_devices(m2_skt_devices, ARRAY_SIZE(m2_skt_devices));
	msm8960_init_hsic();
	msm8960_init_cam();
	msm8960_init_mmc();
...
MACHINE_START(M2_SKT, "SAMSUNG M2_SKT")
	.map_io = msm8960_map_io,
	.reserve = msm8960_reserve,
	.init_irq = msm8960_init_irq,
	.handle_irq = gic_handle_irq,
	.timer = &msm_timer,
	.init_machine = samsung_m2_skt_init,
